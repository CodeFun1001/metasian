"""
METASIAN — FastAPI server exposing full OpenEnv API:
...
app = FastAPI(
    ...
    description=(
        "OpenEnv-compatible RL environment where an AI agent acts as a DevOps engineer "
        "diagnosing and fixing production system failures. "
...
def reset(body: ResetRequest = ResetRequest()):
    """
    OpenEnv reset() — Initialize or restart an episode.
